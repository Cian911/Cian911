...
- [kubeflow/spark-operator @ spark-operator-chart-1.4.2](https://github.com/kubeflow/spark-operator/releases/tag/spark-operator-chart-1.4.2) (2 days ago)
...
- **[nicanorflavier/spf-dkim-dmarc-simplified](https://github.com/nicanorflavier/spf-dkim-dmarc-simplified)** - Email security is a key part of internet communication. But what are SPF, DKIM, and DMARC, and how do they work? This guide will explain it all in simple terms to make these concepts clearer. (2 days ago)
- **[nikolaydubina/go-hackers-delight](https://github.com/nikolaydubina/go-hackers-delight)** - &#34;Hacker&#39;s Delight&#34; in Go (2 days ago)
