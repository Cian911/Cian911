...
- [kubeflow/spark-operator @ spark-operator-chart-1.4.5](https://github.com/kubeflow/spark-operator/releases/tag/spark-operator-chart-1.4.5) (3 days ago)
...
- **[awslabs/data-on-eks](https://github.com/awslabs/data-on-eks)** - DoEKS is a tool to build, deploy and scale Data &amp; ML Platforms on Amazon EKS (4 days ago)
