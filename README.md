...
- [kubeflow/spark-operator @ v2.0.0-rc.0](https://github.com/kubeflow/spark-operator/releases/tag/v2.0.0-rc.0) (2 days ago)
...
- **[spion/adbfs-rootless](https://github.com/spion/adbfs-rootless)** - Mount Android phones on Linux with adb. No root required. (2 days ago)
- **[danvergara/morphos](https://github.com/danvergara/morphos)** - Self-hosted file converter server (5 days ago)
